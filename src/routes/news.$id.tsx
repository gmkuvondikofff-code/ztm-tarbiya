  ...
  return (
    <Layout>
      <article className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-5 text-balance">{title}</h1>
        ...
        {item.cover_image && (
          <img src={item.cover_image} alt={title} className="w-full rounded-2xl mb-8 shadow-elegant" />
        )}

        <div className="prose-content text-lg whitespace-pre-wrap">{content}</div>
